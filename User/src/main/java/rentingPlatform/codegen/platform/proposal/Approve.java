...
public class Approve extends DamlRecord<Approve> {
  ...
  public final Long laId;

  public Approve(String evolveId, Long laId) {
  ...
  public static ValueDecoder<Approve> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      Long laId = PrimitiveValueDecoders.fromInt64.decode(fields$.get(1).getValue());
      return new Approve(evolveId, laId);
    } ;
  }
  ...
  public com.daml.ledger.javaapi.data.DamlRecord toValue() {
    ...
    fields.add(new com.daml.ledger.javaapi.data.DamlRecord.Field("laId", new Int64(this.laId)));
    return new com.daml.ledger.javaapi.data.DamlRecord(fields);
  }

  public static JsonLfDecoder<Approve> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("evolveId", "laId"), name -> {
          switch (name) {
            ...
            case "laId": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(1, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.int64);
            default: return null;
          }
        }
  ...
  public JsonLfEncoder jsonEncoder() {
    return JsonLfEncoders.record(
        ...
        JsonLfEncoders.Field.of("laId", apply(JsonLfEncoders::int64, laId)));
  }
  ...
  public boolean equals(Object object) {
    ...
    return Objects.equals(this.evolveId, other.evolveId) && Objects.equals(this.laId, other.laId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.evolveId, this.laId);
  }

  @Override
  public String toString() {
    return String.format("rentingPlatform.codegen.platform.proposal.Approve(%s, %s)", this.evolveId,
        this.laId);
  }
}

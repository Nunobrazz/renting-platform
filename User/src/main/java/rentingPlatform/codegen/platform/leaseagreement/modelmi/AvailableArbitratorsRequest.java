...
public final class AvailableArbitratorsRequest extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("a6bcfd7383b67eb87e5f0a5348ee1cec07394d6ff60d842a59c6ec0bfb5dfc76", "Platform.LeaseAgreement.ModelMI", "AvailableArbitratorsRequest");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, AvailableArbitratorsRequest> COMPANION = 
      new ContractCompanion.WithoutKey<>(
        "rentingPlatform.codegen.platform.leaseagreement.modelmi.AvailableArbitratorsRequest",
        TEMPLATE_ID, ContractId::new,
        v -> AvailableArbitratorsRequest.templateValueDecoder().decode(v),
  ...
  public String toString() {
    return String.format("rentingPlatform.codegen.platform.leaseagreement.modelmi.AvailableArbitratorsRequest(%s, %s)",

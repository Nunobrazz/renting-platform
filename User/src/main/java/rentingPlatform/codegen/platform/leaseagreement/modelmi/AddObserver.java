...
public class AddObserver extends DamlRecord<AddObserver> {
  ...
  public static JsonLfDecoder<AddObserver> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("requestCid", "public$"), name -> {
          switch (name) {
            case "requestCid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(0, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(rentingPlatform.codegen.platform.leaseagreement.modelmi.AvailableArbitratorsRequest.ContractId::new));
  ...
  public String toString() {
    return String.format("rentingPlatform.codegen.platform.leaseagreement.modelmi.AddObserver(%s, %s)",

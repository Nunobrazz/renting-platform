...
public final class AvailableArbitrators extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("a6bcfd7383b67eb87e5f0a5348ee1cec07394d6ff60d842a59c6ec0bfb5dfc76", "Platform.LeaseAgreement.ModelMI", "AvailableArbitrators");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, AvailableArbitrators> COMPANION = 
      new ContractCompanion.WithoutKey<>(
        "rentingPlatform.codegen.platform.leaseagreement.modelmi.AvailableArbitrators", TEMPLATE_ID,
        ContractId::new, v -> AvailableArbitrators.templateValueDecoder().decode(v),
        AvailableArbitrators::fromJson, Contract::new, List.of(CHOICE_Archive, CHOICE_AddObserver));
  ...
  public String toString() {
    return String.format("rentingPlatform.codegen.platform.leaseagreement.modelmi.AvailableArbitrators(%s, %s, %s)",

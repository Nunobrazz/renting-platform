...
public final class MIReport extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("a6bcfd7383b67eb87e5f0a5348ee1cec07394d6ff60d842a59c6ec0bfb5dfc76", "Platform.LeaseAgreement.ModelMI", "MIReport");
  ...
  public static final ContractCompanion.WithKey<Contract, ContractId, MIReport, Tuple3<String, String, MIdetails>> COMPANION = 
      new ContractCompanion.WithKey<>(
        ...
        Contract::new, List.of(CHOICE_SetArbitrators, CHOICE_CreatePoll, CHOICE_Archive),
  ...
  public static Update<Created<ContractId>> create(String tenant, String host, MIdetails miDetails,
    ...
    return new MIReport(tenant, host, miDetails, arbitrators, activeInvitation).create();
  }
  ...
  private static ValueDecoder<MIReport> templateValueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      Boolean activeInvitation = PrimitiveValueDecoders.fromBool.decode(fields$.get(4).getValue());
      return new MIReport(tenant, host, miDetails, arbitrators, activeInvitation);
    } ;
  }

  public static JsonLfDecoder<MIReport> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("tenant", "host", "miDetails", "arbitrators", "activeInvitation"), name -> {
          switch (name) {
            ...
            case "activeInvitation": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(4, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.bool);
            default: return null;
          }
        }
        , (Object[] args) -> new MIReport(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3]), JsonLfDecoders.cast(args[4])));
  }
  ...
  public String toString() {
    return String.format("rentingPlatform.codegen.platform.leaseagreement.modelmi.MIReport(%s, %s, %s, %s, %s)",
        this.tenant, this.host, this.miDetails, this.arbitrators, this.activeInvitation);
  }

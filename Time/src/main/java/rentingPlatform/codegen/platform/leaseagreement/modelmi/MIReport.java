...
public final class MIReport extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("c911fdfc3964813e1caa91849f67e4b0ec3b6260c2d032ebcdf01d6c820d721b", "Platform.LeaseAgreement.ModelMI", "MIReport");
   ...
   * @deprecated since Daml 2.3.0; use {@code byKey(key).exerciseCreateVotation(visitor,
      visitDetails, vote, cost, assessmentDate, reparationDate)} instead
   */
  @Deprecated
  public static Update<Exercised<Votation.ContractId>> exerciseByKeyCreateVotation(
    ...
    return byKey(key).exerciseCreateVotation(visitor, visitDetails, vote, cost, assessmentDate,
        reparationDate);
  }
  ...
  public Update<Exercised<Votation.ContractId>> createAndExerciseCreateVotation(String visitor,
    ...
    return createAndExerciseCreateVotation(new CreateVotation(visitor, visitDetails, vote, cost,
  ...
  public interface Exercises<Cmd> extends com.daml.ledger.javaapi.data.codegen.Exercises.Archive<Cmd> {
    ...
    default Update<Exercised<Votation.ContractId>> exerciseCreateVotation(String visitor,
        String visitDetails, Responsability vote, Long cost, LocalDate assessmentDate,
        LocalDate reparationDate) {
      return exerciseCreateVotation(new CreateVotation(visitor, visitDetails, vote, cost,
          assessmentDate, reparationDate));
    }
  }

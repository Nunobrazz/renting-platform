...
public final class Poll extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("a6bcfd7383b67eb87e5f0a5348ee1cec07394d6ff60d842a59c6ec0bfb5dfc76", "Platform.LeaseAgreement.ModelMI", "Poll");
  ...
  public static final Choice<Poll, FinalizeVotation, MIresultArbitrators.ContractId> CHOICE_FinalizeVotation = 
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Poll> COMPANION = 
      new ContractCompanion.WithoutKey<>(
        "rentingPlatform.codegen.platform.leaseagreement.modelmi.Poll", TEMPLATE_ID,
        ContractId::new, v -> Poll.templateValueDecoder().decode(v), Poll::fromJson, Contract::new,
        List.of(CHOICE_Vote, CHOICE_FinalizeVotation, CHOICE_Archive));
  ...
  public String toString() {
    return String.format("rentingPlatform.codegen.platform.leaseagreement.modelmi.Poll(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",

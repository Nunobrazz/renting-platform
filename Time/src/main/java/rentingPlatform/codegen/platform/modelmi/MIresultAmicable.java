...
public final class MIresultAmicable extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("6ca065ed990f710397d5bb273336a4eef438fdaf5c0d5e62b6e4e42cb9aa2b70", "Platform.ModelMI", "MIresultAmicable");

  public static final Choice<MIresultAmicable, rentingPlatform.codegen.da.internal.template.Archive, Unit> CHOICE_Archive = 
      Choice.create("Archive", value$ -> value$.toValue(), value$ ->
        rentingPlatform.codegen.da.internal.template.Archive.valueDecoder().decode(value$),
        value$ -> PrimitiveValueDecoders.fromUnit.decode(value$));

  public static final ContractCompanion.WithoutKey<Contract, ContractId, MIresultAmicable> COMPANION = 
      new ContractCompanion.WithoutKey<>(
        "rentingPlatform.codegen.platform.modelmi.MIresultAmicable", TEMPLATE_ID, ContractId::new,
        v -> MIresultAmicable.templateValueDecoder().decode(v), MIresultAmicable::fromJson,
  ...
  public MIresultAmicable(String assessmentCreator, String assessmentSigner, MIdetails miDetails,
  ...
  public Update<Created<ContractId>> create() {
    return new Update.CreateUpdate<ContractId, Created<ContractId>>(new CreateCommand(MIresultAmicable.TEMPLATE_ID, this.toValue()), x -> x, ContractId::new);
  }
  ...
  public static Update<Created<ContractId>> create(String assessmentCreator,
    ...
    return new MIresultAmicable(assessmentCreator, assessmentSigner, miDetails,
        assessment).create();
  }
  ...
  @Override
  protected ContractCompanion.WithoutKey<Contract, ContractId, MIresultAmicable> getCompanion() {
    return COMPANION;
  }
   ...
   */
  @Deprecated
  public static MIresultAmicable fromValue(Value value$) throws IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<MIresultAmicable> valueDecoder() throws IllegalArgumentException {
  ...
  private static ValueDecoder<MIresultAmicable> templateValueDecoder() throws
    ...
    return value$ -> {
      ...
      return new MIresultAmicable(assessmentCreator, assessmentSigner, miDetails, assessment);
    } ;
  }

  public static JsonLfDecoder<MIresultAmicable> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("assessmentCreator", "assessmentSigner", "miDetails", "assessment"), name -> {
        ...
        , (Object[] args) -> new MIresultAmicable(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3])));
  }

  public static MIresultAmicable fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof MIresultAmicable)) {
      return false;
    }
    MIresultAmicable other = (MIresultAmicable) object;
  ...
  public String toString() {
    return String.format("rentingPlatform.codegen.platform.modelmi.MIresultAmicable(%s, %s, %s, %s)",
        this.assessmentCreator, this.assessmentSigner, this.miDetails, this.assessment);
  }

  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<MIresultAmicable> implements Exercises<ExerciseCommand> {
    public ContractId(String contractId) {
      super(contractId);
    }

    @Override
    protected ContractTypeCompanion<? extends com.daml.ledger.javaapi.data.codegen.Contract<ContractId, ?>, ContractId, MIresultAmicable, ?> getCompanion(
        ) {
      return COMPANION;
    }

    public static ContractId fromContractId(
        com.daml.ledger.javaapi.data.codegen.ContractId<MIresultAmicable> contractId) {
      return COMPANION.toContractId(contractId);
    }
  }

  public static class Contract extends com.daml.ledger.javaapi.data.codegen.Contract<ContractId, MIresultAmicable> {
    public Contract(ContractId id, MIresultAmicable data, Optional<String> agreementText,
        Set<String> signatories, Set<String> observers) {
      super(id, data, agreementText, signatories, observers);
    }

    @Override
    protected ContractCompanion<Contract, ContractId, MIresultAmicable> getCompanion() {
      return COMPANION;
    }

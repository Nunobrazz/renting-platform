...
public final class DateClockUpdateEvent extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("08537584ed7a5356973a2deba7db786c7576354638ad57dfcafbaad6c1c125a5", "Time.Clock1", "DateClockUpdateEvent");
  ...
  public static final ContractCompanion.WithKey<Contract, ContractId, DateClockUpdateEvent, Tuple2<String, LocalDate>> COMPANION = 
      new ContractCompanion.WithKey<>("rentingPlatform.codegen.time.clock1.DateClockUpdateEvent",
  ...
  public String toString() {
    return String.format("rentingPlatform.codegen.time.clock1.DateClockUpdateEvent(%s, %s, %s)",

...
public class Finish extends DamlRecord<Finish> {
   ...
   */
  @Deprecated
  public static Finish fromValue(Value value$) throws IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<Finish> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
  ...
  public static JsonLfDecoder<Finish> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
          switch (name) {
            default: return null;
          }
        }
        , (Object[] args) -> new Finish());
  }

  public static Finish fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public String toString() {
    return "rentingPlatform.codegen.platform.modelmi.Finish";
  }
}

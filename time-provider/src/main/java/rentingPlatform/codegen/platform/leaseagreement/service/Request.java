...
import rentingPlatform.codegen.interface$.types.LeaseTerms;

public final class Request extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("bb7737a3fae0dab3c7cecc1b5d7d0840ffd1957d4501f41845dbecbd2bcf97c3", "Platform.LeaseAgreement.Service", "Request");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Request> COMPANION = 
      new ContractCompanion.WithoutKey<>(
        "rentingPlatform.codegen.platform.leaseagreement.service.Request", TEMPLATE_ID,
        ContractId::new, v -> Request.templateValueDecoder().decode(v), Request::fromJson,
        Contract::new, List.of(CHOICE_Withdraw, CHOICE_Reject, CHOICE_Archive, CHOICE_Approve));
  ...
  public Request(String operator, String proposer, House house, LeaseTerms leaseTerms) {
  ...
  public static Update<Created<ContractId>> create(String operator, String proposer, House house,
    ...
    return new Request(operator, proposer, house, leaseTerms).create();
  }
  ...
  private static ValueDecoder<Request> templateValueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new Request(operator, proposer, house, leaseTerms);
    } ;
  }

  public static JsonLfDecoder<Request> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("operator", "proposer", "house", "leaseTerms"), name -> {
          switch (name) {
            ...
            case "leaseTerms": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(3, rentingPlatform.codegen.interface$.types.LeaseTerms.jsonDecoder());
            default: return null;
          }
        }
        , (Object[] args) -> new Request(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3])));
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(this.operator, this.proposer, this.house, this.leaseTerms);
  }

  @Override
  public String toString() {
    return String.format("rentingPlatform.codegen.platform.leaseagreement.service.Request(%s, %s, %s, %s)",
        this.operator, this.proposer, this.house, this.leaseTerms);
  }

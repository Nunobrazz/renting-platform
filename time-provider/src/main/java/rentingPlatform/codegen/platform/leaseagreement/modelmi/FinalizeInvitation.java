...
public class FinalizeInvitation extends DamlRecord<FinalizeInvitation> {
  ...
  public static JsonLfDecoder<FinalizeInvitation> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
        ...
        , (Object[] args) -> new FinalizeInvitation());
  }
  ...
  public String toString() {
    return "rentingPlatform.codegen.platform.leaseagreement.modelmi.FinalizeInvitation";
  }
}

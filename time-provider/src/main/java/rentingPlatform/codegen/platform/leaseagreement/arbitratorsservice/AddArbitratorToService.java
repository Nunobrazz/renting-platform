...
public class AddArbitratorToService extends DamlRecord<AddArbitratorToService> {
  ...
  public AddArbitratorToService(String arbitrator) {
   ...
   */
  @Deprecated
  public static AddArbitratorToService fromValue(Value value$) throws IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<AddArbitratorToService> valueDecoder() throws
    ...
    return value$ -> {
      ...
      return new AddArbitratorToService(arbitrator);
    } ;
  }
  ...
  public static JsonLfDecoder<AddArbitratorToService> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("arbitrator"), name -> {
        ...
        , (Object[] args) -> new AddArbitratorToService(JsonLfDecoders.cast(args[0])));
  }

  public static AddArbitratorToService fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof AddArbitratorToService)) {
      return false;
    }
    AddArbitratorToService other = (AddArbitratorToService) object;
  ...
  public String toString() {
    return String.format("rentingPlatform.codegen.platform.leaseagreement.arbitratorsservice.AddArbitratorToService(%s)",
        this.arbitrator);
  }
}

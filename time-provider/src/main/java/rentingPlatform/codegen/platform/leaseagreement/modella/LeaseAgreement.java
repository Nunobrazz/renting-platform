...
public final class LeaseAgreement extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("3ab0b0842cdffab8c416d02894ad44bcc570eeb048f996af3c2257fb08640ba3", "Platform.LeaseAgreement.ModelLA", "LeaseAgreement");
  ...
  public static JsonLfDecoder<LeaseAgreement> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("operator", "lifecycler", "tenant", "house", "leaseTerms", "paymentsToProcess"), name -> {
          switch (name) {
            ...
            case "house": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(3, rentingPlatform.codegen.interface$.types.House.jsonDecoder());
            case "leaseTerms": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(4, rentingPlatform.codegen.interface$.types.LeaseTerms.jsonDecoder());

...
public final class Role extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("bb7737a3fae0dab3c7cecc1b5d7d0840ffd1957d4501f41845dbecbd2bcf97c3", "Platform.Role.Operator", "Role");
  ...
  public static final Choice<Role, CreateArbitratorsService, rentingPlatform.codegen.platform.leaseagreement.arbitratorsservice.Service.ContractId> CHOICE_CreateArbitratorsService = 
      Choice.create("CreateArbitratorsService", value$ -> value$.toValue(), value$ ->
        CreateArbitratorsService.valueDecoder().decode(value$), value$ ->
        new rentingPlatform.codegen.platform.leaseagreement.arbitratorsservice.Service.ContractId(value$.asContractId().orElseThrow(() -> new IllegalArgumentException("Expected value$ to be of type com.daml.ledger.javaapi.data.ContractId")).getValue()));
  ...
  public static final ContractCompanion.WithKey<Contract, ContractId, Role, String> COMPANION = 
      new ContractCompanion.WithKey<>("rentingPlatform.codegen.platform.role.operator.Role",
        ...
        CHOICE_ApproveLeaseAgreementService, CHOICE_Archive, CHOICE_CreateArbitratorsService,
        CHOICE_ApproveArbitratorService), e -> PrimitiveValueDecoders.fromParty.decode(e));
  ...
  /**
   * @deprecated since Daml 2.3.0; use {@code byKey(key).exerciseApproveArbitratorService(serviceReqCid,
      serviceCid)} instead
   */
  @Deprecated
  public static Update<Exercised<rentingPlatform.codegen.platform.leaseagreement.arbitratorsservice.Service.ContractId>> exerciseByKeyApproveArbitratorService(
      ...
      rentingPlatform.codegen.platform.leaseagreement.arbitratorsservice.Service.ContractId serviceCid) {
    return byKey(key).exerciseApproveArbitratorService(serviceReqCid, serviceCid);
  }
  ...
  /**
   * @deprecated since Daml 2.3.0; use {@code byKey(key).exerciseOfferArbitratorService(arbitrator,
      serviceCid)} instead
   */
  @Deprecated
  public static Update<Exercised<Offer.ContractId>> exerciseByKeyOfferArbitratorService(String key,
      String arbitrator,
      rentingPlatform.codegen.platform.leaseagreement.arbitratorsservice.Service.ContractId serviceCid) {
    return byKey(key).exerciseOfferArbitratorService(arbitrator, serviceCid);
  }

  /**
   * @deprecated since Daml 2.3.0; use {@code byKey(key).exerciseCreateArbitratorsService} instead
   */
  @Deprecated
  public static Update<Exercised<rentingPlatform.codegen.platform.leaseagreement.arbitratorsservice.Service.ContractId>> exerciseByKeyCreateArbitratorsService(
      String key, CreateArbitratorsService arg) {
    return byKey(key).exerciseCreateArbitratorsService(arg);
  }
  ...
  public static Update<Exercised<rentingPlatform.codegen.platform.leaseagreement.arbitratorsservice.Service.ContractId>> exerciseByKeyCreateArbitratorsService(
      String key) {
    return byKey(key).exerciseCreateArbitratorsService();
  }
  ...
  /**
   * @deprecated since Daml 2.3.0; use {@code createAnd().exerciseCreateArbitratorsService} instead
   */
  @Deprecated
  public Update<Exercised<rentingPlatform.codegen.platform.leaseagreement.arbitratorsservice.Service.ContractId>> createAndExerciseCreateArbitratorsService(
      CreateArbitratorsService arg) {
    return createAnd().exerciseCreateArbitratorsService(arg);
  }
  ...
  public Update<Exercised<rentingPlatform.codegen.platform.leaseagreement.arbitratorsservice.Service.ContractId>> createAndExerciseCreateArbitratorsService(
    ...
    return createAndExerciseCreateArbitratorsService(new CreateArbitratorsService());
  }
  ...
  public interface Exercises<Cmd> extends com.daml.ledger.javaapi.data.codegen.Exercises.Archive<Cmd> {
    ...
    default Update<Exercised<Offer.ContractId>> exerciseOfferArbitratorService(String arbitrator,
        rentingPlatform.codegen.platform.leaseagreement.arbitratorsservice.Service.ContractId serviceCid) {
      return exerciseOfferArbitratorService(new OfferArbitratorService(arbitrator, serviceCid));
    }

    default Update<Exercised<rentingPlatform.codegen.platform.leaseagreement.arbitratorsservice.Service.ContractId>> exerciseCreateArbitratorsService(
        CreateArbitratorsService arg) {
      return makeExerciseCmd(CHOICE_CreateArbitratorsService, arg);
    }

    default Update<Exercised<rentingPlatform.codegen.platform.leaseagreement.arbitratorsservice.Service.ContractId>> exerciseCreateArbitratorsService(
        ) {
      return exerciseCreateArbitratorsService(new CreateArbitratorsService());
    }

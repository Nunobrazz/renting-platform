...
public class AcceptProposal extends DamlRecord<AcceptProposal> {
  ...
  public AcceptProposal(Proposal.ContractId proposalCid) {
  ...
  public static ValueDecoder<AcceptProposal> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new AcceptProposal(proposalCid);
    } ;
  }
  ...
  public static JsonLfDecoder<AcceptProposal> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("proposalCid"), name -> {
        ...
        , (Object[] args) -> new AcceptProposal(JsonLfDecoders.cast(args[0])));
  }

  public static AcceptProposal fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public String toString() {
    return String.format("rentingPlatform.codegen.platform.proposal.service.AcceptProposal(%s)",
        this.proposalCid);
  }
}

...
public final class Proposal extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("0cf664e7a7bad84bfc31440cc4ea2b4c71a9a628dbeb0437bb65cac5ef779e5e", "Platform.Proposal.Model", "Proposal");
  ...
  public static JsonLfDecoder<Proposal> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("proposer", "house", "leaseTerms", "alreadySigned"), name -> {
          switch (name) {
            ...
            case "leaseTerms": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(2, rentingPlatform.codegen.interface$.types.LeaseTerms.jsonDecoder());

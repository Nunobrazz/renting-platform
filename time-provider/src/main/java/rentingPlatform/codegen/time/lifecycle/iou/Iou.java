...
public final class Iou extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("bb7737a3fae0dab3c7cecc1b5d7d0840ffd1957d4501f41845dbecbd2bcf97c3", "Time.Lifecycle.Iou", "Iou");
  ...
  public Iou(String creator, String debtor, String owner, Long amount) {
  ...
  public static Update<Created<ContractId>> create(String creator, String debtor, String owner,
      Long amount) {
    return new Iou(creator, debtor, owner, amount).create();
  }
  ...
  private static ValueDecoder<Iou> templateValueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new Iou(creator, debtor, owner, amount);
    } ;
  }

  public static JsonLfDecoder<Iou> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("creator", "debtor", "owner", "amount"), name -> {
          switch (name) {
        ...
        , (Object[] args) -> new Iou(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3])));
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(this.creator, this.debtor, this.owner, this.amount);
  }

  @Override
  public String toString() {
    return String.format("rentingPlatform.codegen.time.lifecycle.iou.Iou(%s, %s, %s, %s)",
        this.creator, this.debtor, this.owner, this.amount);
  }

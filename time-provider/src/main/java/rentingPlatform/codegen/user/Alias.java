...
public final class Alias extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("0cf664e7a7bad84bfc31440cc4ea2b4c71a9a628dbeb0437bb65cac5ef779e5e", "User", "Alias");
  ...
  public static final ContractCompanion.WithKey<Contract, ContractId, Alias, Tuple2<String, String>> COMPANION = 
      new ContractCompanion.WithKey<>("rentingPlatform.codegen.user.Alias", TEMPLATE_ID,
        ContractId::new, v -> Alias.templateValueDecoder().decode(v), Alias::fromJson,
        Contract::new, List.of(CHOICE_Archive, CHOICE_Change), e -> Tuple2.<java.lang.String,
  ...
  public String toString() {
    return String.format("rentingPlatform.codegen.user.Alias(%s, %s, %s)", this.username,

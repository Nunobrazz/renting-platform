...
exports.TriggerConfig = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({maxInFlightCommands: damlTypes.Int.decoder, maxActiveContracts: damlTypes.Int.decoder, }); }),
  encode: function (__typed__) {
  return {
    maxInFlightCommands: damlTypes.Int.encode(__typed__.maxInFlightCommands),
    maxActiveContracts: damlTypes.Int.encode(__typed__.maxActiveContracts),
  };
}
,
};

...
exports.AddLA = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({laKey: Platform_Types_LA.LAkey.decoder, }); }),
  encode: function (__typed__) {
  return {
...
{
  templateId: 'f18eb482c25f64cd721de470f30dbf6a8247ca127e6e772be98e809b5cbf23a3:Time.Lifecycle.Evolve:Evolve',
  keyDecoder: damlTypes.lazyMemo(function () { return jtv.constant(undefined); }),
  keyEncode: function () { throw 'EncodeError'; },
  decoder: damlTypes.lazyMemo(function () { return jtv.object({operator: damlTypes.Party.decoder, lifecycler: damlTypes.Party.decoder, laKeys: pkg97b883cd8a2b7f49f90d5d39c981cf6e110cf1f1c64427a28a6d58ec88c43657.DA.Set.Types.Set(Platform_Types_LA.LAkey).decoder, }); }),
  encode: function (__typed__) {
  return {
    operator: damlTypes.Party.encode(__typed__.operator),
    lifecycler: damlTypes.Party.encode(__typed__.lifecycler),
    laKeys: pkg97b883cd8a2b7f49f90d5d39c981cf6e110cf1f1c64427a28a6d58ec88c43657.DA.Set.Types.Set(Platform_Types_LA.LAkey).encode(__typed__.laKeys),
  };
}
,
  AddLA: {

...
public class RequestLeaseAgreement extends DamlRecord<RequestLeaseAgreement> {
  ...
  public RequestLeaseAgreement(String signer, Proposal.ContractId proposalCid) {
    this.signer = signer;
  ...
  public static ValueDecoder<RequestLeaseAgreement> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new RequestLeaseAgreement(signer, proposalCid);
    } ;
  }
  ...
  public String toString() {
    return String.format("rentingPlatform.codegen.platform.proposal.service.RequestLeaseAgreement(%s, %s)",

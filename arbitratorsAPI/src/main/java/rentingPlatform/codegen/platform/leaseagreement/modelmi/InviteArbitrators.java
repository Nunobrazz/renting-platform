...
public final class InviteArbitrators extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("b80ed0eb60b6c3d918d4f24fbb5689a03c7ad2642b523a689de07104f792b41f", "Platform.LeaseAgreement.ModelMI", "InviteArbitrators");
  ...
  public InviteArbitrators(String operator, Set<String> invited, Set<String> confirmed,
      MIdetails miDetails) {
  ...
  public static Update<Created<ContractId>> create(String operator, Set<String> invited,
      Set<String> confirmed, MIdetails miDetails) {
    return new InviteArbitrators(operator, invited, confirmed, miDetails).create();
  }
  ...
  private static ValueDecoder<InviteArbitrators> templateValueDecoder() throws
    ...
    return value$ -> {
      ...
      return new InviteArbitrators(operator, invited, confirmed, miDetails);
    } ;
  }

  public static JsonLfDecoder<InviteArbitrators> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("operator", "invited", "confirmed", "miDetails"), name -> {
          switch (name) {
        ...
        , (Object[] args) -> new InviteArbitrators(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3])));
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(this.operator, this.invited, this.confirmed, this.miDetails);
  }

  @Override
  public String toString() {
    return String.format("rentingPlatform.codegen.platform.leaseagreement.modelmi.InviteArbitrators(%s, %s, %s, %s)",
        this.operator, this.invited, this.confirmed, this.miDetails);
  }

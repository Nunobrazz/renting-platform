...
public final class InviteArbitrators extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("b1c69ded5e6f9b3209adda4613b08585e35d988f49cc818e5af8942f840887f7", "Platform.LeaseAgreement.ModelMI", "InviteArbitrators");
  ...
  public static final Choice<InviteArbitrators, Accept, Unit> CHOICE_Accept = 
   ...
   */
  @Deprecated
  public Update<Exercised<Unit>> createAndExerciseAccept(Accept arg) {
   ...
   */
  @Deprecated
  public Update<Exercised<Unit>> createAndExerciseAccept(String arbitrator) {
  ...
  public interface Exercises<Cmd> extends com.daml.ledger.javaapi.data.codegen.Exercises.Archive<Cmd> {
    ...
    default Update<Exercised<Unit>> exerciseAccept(Accept arg) {
      return makeExerciseCmd(CHOICE_Accept, arg);
    }

    default Update<Exercised<Unit>> exerciseAccept(String arbitrator) {

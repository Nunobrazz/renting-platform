...
public final class Offer extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("b80ed0eb60b6c3d918d4f24fbb5689a03c7ad2642b523a689de07104f792b41f", "Platform.LeaseAgreement.ArbitratorsService", "Offer");
  ...
  public Offer(String operator, String arbitrator) {
  ...
  public static Update<Created<ContractId>> create(String operator, String arbitrator) {
    return new Offer(operator, arbitrator).create();
  }
  ...
  private static ValueDecoder<Offer> templateValueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new Offer(operator, arbitrator);
    } ;
  }
  ...
  public String toString() {
    return String.format("rentingPlatform.codegen.platform.leaseagreement.arbitratorsservice.Offer(%s, %s)",

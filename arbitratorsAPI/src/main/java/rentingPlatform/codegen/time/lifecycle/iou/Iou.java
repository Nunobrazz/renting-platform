...
public final class Iou extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("b80ed0eb60b6c3d918d4f24fbb5689a03c7ad2642b523a689de07104f792b41f", "Time.Lifecycle.Iou", "Iou");
  ...
  public Iou(String creator, String debtor, String owner, Long amount, LocalDate paymentDate,
  ...
  public static Update<Created<ContractId>> create(String creator, String debtor, String owner,
      Long amount, LocalDate paymentDate, LocalDate creationDate) {
    return new Iou(creator, debtor, owner, amount, paymentDate, creationDate).create();
  }
  ...
  public DamlRecord toValue() {
    ...
    fields.add(new DamlRecord.Field("paymentDate", new Date((int) this.paymentDate.toEpochDay())));
  ...
  private static ValueDecoder<Iou> templateValueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      LocalDate paymentDate = PrimitiveValueDecoders.fromDate.decode(fields$.get(4).getValue());
      LocalDate creationDate = PrimitiveValueDecoders.fromDate.decode(fields$.get(5).getValue());
      return new Iou(creator, debtor, owner, amount, paymentDate, creationDate);
    } ;
  }

  public static JsonLfDecoder<Iou> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("creator", "debtor", "owner", "amount", "paymentDate", "creationDate"), name -> {
          switch (name) {
            ...
            case "paymentDate": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(4, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.date);
            case "creationDate": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(5, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.date);
            default: return null;
          }
        }
        , (Object[] args) -> new Iou(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3]), JsonLfDecoders.cast(args[4]), JsonLfDecoders.cast(args[5])));
  }
  ...
  public JsonLfEncoder jsonEncoder() {
    return JsonLfEncoders.record(
        ...
        JsonLfEncoders.Field.of("paymentDate", apply(JsonLfEncoders::date, paymentDate)),
  ...
  public boolean equals(Object object) {
    ...
    return Objects.equals(this.creator, other.creator) &&
        ...
        Objects.equals(this.paymentDate, other.paymentDate) &&
        Objects.equals(this.creationDate, other.creationDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.creator, this.debtor, this.owner, this.amount, this.paymentDate,
        this.creationDate);
  }

  @Override
  public String toString() {
    return String.format("rentingPlatform.codegen.time.lifecycle.iou.Iou(%s, %s, %s, %s, %s, %s)",
        this.creator, this.debtor, this.owner, this.amount, this.paymentDate, this.creationDate);
  }
